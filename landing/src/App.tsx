...
const HERO_LINES: Record<Lang, CLine[]> = {
  en: [
    ...
    [{ text: "claude plugin marketplace add mrcoder/pip" }],
...
function InstallTabs({ L }: { L: (value: Record<Lang, string>) => string }) {
  ...
  const content = {
    claude: {
      ...
      code: "claude plugin marketplace add mrcoder/pip\nclaude plugin install pip@pip-skills",
    },
    codex: {
        ...
        <div className="container" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0.625rem 1.5rem" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "1.5rem" }}>
            ...
            <div className="top-links">
              ...
              <a href="https://github.com/mrcoder/pip" target="_blank" rel="noopener noreferrer">GitHub</a>
            </div>
          </div>
          ...
          <div>
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.5 }}>
              <div className="btn-group">
                ...
                <a href="https://github.com/mrcoder/pip" target="_blank" rel="noopener noreferrer" className="btn-ghost">
