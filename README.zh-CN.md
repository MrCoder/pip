...
一个 AI Coding Agent 技能插件，用中西大厂 PIP 话术驱动 AI 穷尽所有方案才允许放弃。支持 **Claude Code**、**OpenAI Codex CLI**、**Cursor**、**Kiro**、**OpenClaw**、**Google Antigravity** 和 **OpenCode**。三重能力：
...
curl -o .claude/agents/pip-enforcer.md \
  https://raw.githubusercontent.com/tanweai/pua/main/agents/pip-enforcer.md
```
